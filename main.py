...
def configurar_pagina():
    ...
    st.set_page_config(page_title="C.G.R", page_icon= "🤎")
    st.title("C.G.R")
    st.sidebar.title("Seleccion de modelos")

    elegirModelo = st.sidebar.selectbox("Elegi un modelo", options=MODELOS, index=0, key="selector_modelo_sidebar")
...
def main():
    ...
    if promt_del_usuario:
        ...
        if respuesta_del_bot:
            ...
            respuesta_posta = respuesta_del_bot.choices[0].message.content
